...
const EditCandidateProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (updatedCandidateProfile.resume) {
                setResumePreview(`data:application/pdf;base64,${updatedCandidateProfile.resume}`);
            }
            if (updatedCandidateProfile.medicalReport) {
                setMedicalReportPreview(`data:application/pdf;base64,${updatedCandidateProfile.medicalReport}`);
            }
        ...
        <div className="flex flex-col mx-auto">
          ...
          {isLoading ? (
            ...
            <div className="space-y-5">
                <div>
                    <label htmlFor="" className="text-base font-medium text-[#0A66C2]">
                    {' '}
                    Full Name{' '}
                    </label>
                    <div className="mt-2">
              ...
              <div>
                ...
                <div className="mt-2">
                    <input 
                        ...
                        name="resume" 
                        id="resume" 
                        className="shadow focus:ring-[#0A66C2] focus:border-[#0A66C2] appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
